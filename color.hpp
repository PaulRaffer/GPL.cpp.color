...
#ifndef GPL_COLOR_COLOR_HPP
#define GPL_COLOR_COLOR_HPP
...
template <typename T>
constexpr color<T>::color(T red, T green, T blue)
:
	red{red}, green{green}, blue{blue}
{}

template <typename T>
constexpr color<T>::color(T brightness)
:
...
constexpr color<T>::color(color<T1> const & rhs)
:
...
template <typename T>
constexpr auto color<T>::get_red() const
{
	return red;
}

template <typename T>
void color<T>::set_red(T red)
{
	this->red = red;
}
...
template <typename T>
constexpr auto color<T>::get_green() const
{
	return green;
}

template <typename T>
void color<T>::set_green(T green)
{
	this->green = green;
}
...
template <typename T>
constexpr auto color<T>::get_blue() const
{
	return blue;
}

template <typename T>
void color<T>::set_blue(T blue)
{
	this->blue = blue;
}
...
auto operator--(color<auto> & lhs, int) -> auto const
{
	auto temp = lhs; lhs -= 1; return temp;
}
